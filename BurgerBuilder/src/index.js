...
// thunk is a middleare which is used to execute the code asynchronously i.e we can use setTimeout() function
// in an action.js page
import thunk from 'redux-thunk';

import orderReducer from './store/reducers/order';

// Used to connect React with react-console
